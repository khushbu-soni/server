...
class Customer_name extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->data['dependencies'] = $this->load->view('general/dependencies', '', TRUE);
			...
			$this->data['menuheader'] = $this->load->view('manager/customer_name_header', '', TRUE);
	...
	public function index()
	{
		...
		$this->load->view('manager/customer_name', $this->data);
	}
	...
	*/
	public function setname()
	{
		...
		if (empty($temp_name)) {
			$this->session->set_flashdata('sameuser', "Please Enter Name.");

			redirect('manager/customer_name', 'refresh');
		}
		...
		$this->session->set_userdata(array('mobile'=>$this->input->post('key')));
		$this->session->set_userdata(array('count'=>$count));

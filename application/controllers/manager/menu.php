...
class Menu extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->data['w_id']=$this->session->userdata('usertid');

		$this->data['menuheader'] = $this->load->view('manager/customermenuheader', '', TRUE);
		$this->data['dependencies'] = $this->load->view('general/dependencies', '', TRUE);
		$this->data['yourorder'] = $this->load->view('manager/yourorder', '', TRUE);
		
		$this->data['moreinfo'] = $this->load->view('manager/moreinfo', '', TRUE);
		$this->data['customize'] = $this->load->view('manager/customize', '', TRUE);
	...
	public function index()
	{
		...
		$this->data['menucontent'] = $this->load->view('manager/menucontent', $content_data, TRUE);
		...
		$this->load->view('manager/menu', $this->data);
	}
	...
	public function placeorder()
	{
        ...
        //Create order
        $order = $this->order_model->insert_order_by_manager();
        $tempData = array('orderid'=>$order);
        $this->session->set_userdata($tempData);
        //Create order items
        foreach($productsArr as $product){
            $this->load->model('orderitem_model');
            $this->orderitem_model->insert_orderitem_by_manager($product->menuid, $order, $product->ingredients,$product->price,$product->quantity);            
        }

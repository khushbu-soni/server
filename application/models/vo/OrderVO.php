...
class OrderVO {
	...
	*/
	...
	public function getOrderedItems_kitchen()
	{
		//echo $this->CI->db->last_query();
		...
		$this->CI->db->where_in('orderitem.status', $status);
	...
	public function getOrderedItems_kitchen_dlvr()
	{
		//echo $this->CI->db->last_query();
	...
	public function getOrderedItems_manager()
	{
		//echo $this->CI->db->last_query();

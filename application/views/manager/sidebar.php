                        ...
                        if(!empty($record->childs)) {
                            ...
                            foreach($record->childs as $c) 
                            {
                                  ...
                                  echo '<ul class="nav nav-second-level collapse" >
                                            <li>
                                               <a class=""  href="'.site_url().'manager/'.$c->menu_url.'"><i class="fa '.$record->icon.' fa-3x"></i><br/>'.$c->menu_name.'</a>
                                            </li>
                            ...
                            echo 'href="'.base_url().'manager/'.$record->menu_url.'"><i class="fa '.$record->icon.' fa-3x"></i><br/>'.$record->menu_name.'</a>';
                        }
                         echo '</li>';

      ...
      <div class="tabbable-panel">
        <div class="tabbable-line">
            ...
            <button id="paid-btn" class="btn btn-pink">
             ...
             <button id="day_report-btn" class="btn btn-warning">
  ...
  <div class="modal-dialog">
    ...
    <div class="clearfix"></div>
          ...
          <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                        <label>Restro</label>
                                            <select name="restro" id="restro"  class="form-control input-sm">
                                            <option value="no">All</option>
                                            <option value="BH">Biryani House</option>
                                            <option value="CS">Cafe One Six</option>
            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">Restro Category</th>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select class="form-control" id="payment_against">
          ...
          <option value="directors">From Directors</option>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select class="form-control" name="transaction_type" id="transaction_type" onchange="get_value()">
          ...
          <option value="directors">Taken By Directors</option>
          <option value="bank">Deposite To Bank</option>
...
<script src="<?php echo base_url() . 'assets/binary-assets/js/bootstrap-datetimepicker.js'?>" charset="UTF-8"></script>
  ...
  <script src="<?php echo base_url() . 'assets/binary-assets/js/jquery.base64.js'?>" charset="UTF-8"></script>
    ...
    $( "#from_date_day" ).change(function() {
      ...
      var url = "<?php echo site_url('manager/accounts/get_day_report'); ?>" 
      var start_date = $('#from_date_day').val();
      var end_date = $('#to_date_day').val();
      var type = $('#filter_payment').val();
      var restro = $('#restro').val();
            var postdata = {'start_date' :start_date,'end_date':end_date,'type':type,'restro':restro};
                $.post(url,postdata, function(data){
      ...
      $( "#restro" ).change(function() {
        
      var url = "<?php echo site_url('manager/accounts/get_day_report'); ?>" 
      var start_date = $('#from_date_day').val();
      var end_date = $('#to_date_day').val();
      var restro = $('#restro').val();
            var postdata = {'start_date' :start_date,'end_date':end_date,'restro':restro};
                $.post(url,postdata, function(data){

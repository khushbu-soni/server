...
function scrollit() {
	...
	<body>
		...
		?>
		 ...
		 -->
					<div id="flip">Food</div>
					
					<div class="outer-frame rounded-6px" id="panel" style="max-height:600px;  margin-bottom:10px;">
					...
					<?php print_r($this->session->all_userdata()); ?></pre> 	 -->
								...
								foreach ($get_profile as $getprofile) { 
									if($this->session->userdata('customermobile') == $getprofile->mobile)
								{								
								echo $getprofile->customer_name;
							}else if($this->session->userdata('customername') == $getprofile->customer_name)
								{								
								echo $getprofile->customer_name;
							}else
							{
								 ...
								 } }elseif(empty($get_profile)){ echo "Guest";}else{?>
							...
							<div class="rightmenucontent">
								...
								<div id="menuname"><a href="#" onclick="getMenuItemsAll(event)"  class="">All</a></div>
								<?php 
								foreach ($menutypes as $menutype) { ?>
									<div id="menuname">
									<a href="#" onclick="getMenuItems(event)" type="<?php echo $menutype->id;?>" class=""><?php echo $menutype->menutype_name;?></a></li></div>

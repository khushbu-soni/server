        ...
        foreach($rootCategories as $record) {
              ...
              echo  '<li>';
                        ...
                        if(!empty($record->childs)) {
                               ...
                               echo ' href="#"><i class="fa '.$record->icon.' fa-3x"></i>'.$record->menu_name.'<span class="fa arrow"></span></a>';
                            foreach($record->childs as $c) 
                            {
                                  ...
                                  echo '<ul class="nav nav-second-level collapse" >
                                            <li>
                                               <a class=""  href="'.site_url().'kitchen/'.$c->menu_url.'"><i class="fa '.$record->icon.' fa-3x"></i>'.$c->menu_name.'</a>
                                            </li>
                            ...
                            echo 'href="'.base_url().'kitchen/'.$record->menu_url.'"><i class="fa '.$record->icon.' fa-3x"></i>'.$record->menu_name.'</a>';
                        }
                         echo '</li>';

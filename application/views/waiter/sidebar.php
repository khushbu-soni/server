                        ...
                        if(!empty($record->childs)) {
                            ...
                            foreach($record->childs as $c) 
                            {
                                  ...
                                  echo '<ul class="nav nav-second-level collapse" >
                                            <li>
                                               <a class=""  href="'.site_url().'waiter/'.$c->menu_url.'"><i class="fa '.$record->icon.' fa-3x"></i>'.$c->menu_name.'</a>
                                            </li>
                            ...
                            echo 'href="'.base_url().'waiter/'.$record->menu_url.'"><i class="fa '.$record->icon.' fa-3x"></i>'.$record->menu_name.'</a>';
                        }
                         echo '</li>';

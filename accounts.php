...
class Accounts extends CI_Controller {
	...
	public  function get_day_report(){
			...
			$records=$this->transaction->get_item_info($start_date,$end_date);
			$total_take_away=$this->transaction->total_take_away($start_date,$end_date);
			$total_table_order=$this->transaction->total_table_order($start_date,$end_date);
			...
			$tr.="<tr>
					<td class='alert alert-danger' colspan='2'>Total No of Take Away Order ::".$total_take_away['total_take_away']." </td>
					<td colspan='2'></td>
				 </tr>";
				 $tr.="<tr>
					<td class='alert alert-info' colspan='2'>Total No of Take Away Order ::".$total_table_order['table_order']."  </td>
					<td colspan='2'></td>
				 </tr>";
			echo $tr;
